...
export function CareerPage() {
  ...
  return <div className="space-y-12">
    ...
    <section className="rounded-2xl glass-strong border border-primary/30 p-6"><div className="flex flex-wrap items-start justify-between gap-4"><div><p className="text-xs uppercase text-primary-glow">Current open position</p><h2 className="mt-2 text-2xl font-bold">Growth & Customer Success Executive</h2><div className="mt-3 flex flex-wrap gap-3 text-sm text-muted-foreground"><span className="flex items-center gap-1"><Wifi className="h-4 w-4"/>Remote</span><span className="flex items-center gap-1"><Timer className="h-4 w-4"/>Full Time · 0–2 Years</span><span className="flex items-center gap-1"><MapPin className="h-4 w-4"/>Remote / Bangladesh</span></div></div><a href={syllabusAsset.url} download="Ristop-Interview-Syllabus.pdf"><Button variant="outline"><Download className="h-4 w-4 mr-2"/>Download Interview Syllabus</Button></a></div></section>
